...
async function seed() {
  ...
  await db.insert(forumCategories).values([
    ...
    { name: "Questions", description: "Ask questions and get help from the community", icon: "HelpCircle", color: "chart-1", group: "Community", order: 5 },
    ...
    { name: "Member & Staff Reports", description: "Report members and staff", icon: "Flag", color: "destructive", group: "Moderation", order: 14 },
    { name: "Member Reports", description: "Report community members", icon: "Flag", color: "destructive", group: "Moderation", order: 15 },
    { name: "Staff Abuse Reports", description: "Report staff misconduct", icon: "AlertOctagon", color: "destructive", group: "Moderation", order: 16 },
  ]);
