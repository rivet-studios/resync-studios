      ...
      <Card className="border-none shadow-sm bg-white overflow-hidden">
        <div className="divide-y divide-slate-100">
          {threads?.map((thread) => (
            <div
              key={thread.id}
              className="p-5 flex items-start gap-5 hover:bg-slate-50/50 transition-colors group"
            >
              ...
              <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
                ...
                {thread.isPinned && (
                  <Badge className="bg-amber-50 text-amber-600 border-amber-100 text-[10px] px-1.5">
                    PINNED
                  </Badge>
                )}
              </div>
