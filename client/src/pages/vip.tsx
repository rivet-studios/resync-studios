...
const tiers = [
  ...
  },
  {
    ...
    features: [
      'Sapphire VIP Badge on profile',
      'Priority LFG Matching',
      'Custom Profile Banner',
      'Sapphire Discord Role',
      'Exclusive Builds Access',
      'Ad-Free Experience',
  ...
  },
  {
    ...
    features: [
      'Exclusive Founders Badge (Limited)',
      'All Diamond VIP Features',
      'Founders Discord Role',
      'Early Access to New Features',
      'Direct Developer Communication',
      'Unlimited Clan Size',
      'Custom In-Game Perks',
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Exclusive perks in all REACT Studios games when linked.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
