...
export default function TermsOfService() {
  return (
    <PolicyWrapper slug="terms" title="Terms & Conditions" effectiveDate="17/06/2018" version={3}>
      ...
      <p>You are solely responsible for maintaining the confidentiality of Your Account credentials, including Your username, password, and any linked authentication methods. You agree to immediately notify Us at support@rivetstudiosus.com of any unauthorized access to or use of Your Account. The Company shall not be liable for any loss, damage, or liability arising from Your failure to secure Your Account. All activity occurring under Your Account is Your sole responsibility, whether or not authorized by You.</p>
      ...
      <p>Initiating a chargeback, payment dispute, reversal, or claim through Your bank, credit card issuer, payment processor, or any third party — without first contacting Our support team at support@rivetstudiosus.com and allowing a minimum of fifteen (15) business days to investigate and resolve the issue — constitutes a material breach of these Terms and may be treated as fraud. Consequences of unauthorized chargebacks include immediate Account termination, cost recovery, evidence submission to payment processors, and pursuit of all available legal remedies.</p>
      ...
      <p>Before initiating arbitration, You must first contact Us at support@rivetstudiosus.com and attempt to resolve the Dispute informally for a period of thirty (30) days. If the Dispute is not resolved informally, either party may initiate arbitration.</p>
      ...
      <p>If You have any questions about these Terms, please contact Us at: <strong>support@rivetstudiosus.com</strong></p>
    </PolicyWrapper>
  );
}
