...
export default function LEOGuidelines() {
  return (
    <PolicyWrapper slug="leo-guidelines">
      <div className="container mx-auto px-4 py-8 max-w-4xl space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  Department guidelines can vary as each team is vastly
                  different with The Golden Era. Departments are allowed to
                  modify these rules in an exceptional manner. However, these
                  rules should stay within the guidelines in other department
                  server guidelines.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-4">
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                Emergency Services personnel must maintain professionalism at
                all times, both on-duty and off-duty. This includes how you
                speak to players, respond to situations, and represent your
                department.
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                Using your position to gain unfair advantages, harass players,
                or interfere with unrelated RP is strictly prohibited.
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                ...
                should be taken to internal command channels or reported to
                staff if necessary.
              </CardContent>
            </Card>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                Keep radio communications clear and concise. Avoid cluttering
                the channel with unnecessary chatter during active situations.
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                Use your proper in-game unit call sign (e.g., 3P22, MED02) when
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                During critical incidents, request "priority traffic" if needed.
                All non-essential radio traffic must cease until the scene is
                cleared or command ends the priority.
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                ...
                responsibility to another unit, clearly state that over the
                radio so both sides acknowledge.
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                Emergency Services personnel must have a valid in-character
                reason for their patrol. Do not drive aimlessly or insert
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                ...
                role requires it. Do not escalate unless there is clear and
                direct threat.
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                ...
                enforcement; EMS handles treatment. In large incidents, follow
                the direction of the commanding officer on scene, even if from
                another department.
              </CardContent>
            </Card>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                Do not draw your firearm unless you suspect a threat. You may
                only fire when someone poses a direct and immediate threat.
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                Tasers may only be used when the suspect is actively resisting
                or fleeing. You may not tase someone who is facing you with a
                weapon unless it is holstered or they are running at you with a
                knife.
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>
                  <strong>Warning shots are NOT allowed.</strong> You must make
                  a clear decision to engage or not.
                </p>
                <p>
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardContent className="p-6 text-sm text-muted-foreground space-y-3">
              ...
              <p>
                <strong>Mutual Aid:</strong> You may assist other departments
                only if requested or if the situation presents immediate danger
                to life.
              </p>
              <p>
                <strong>Scene Ownership:</strong> The first unit on scene may
                take initial control, but must hand over to a higher-ranking or
                more relevant department once they arrive.
              </p>
              <p>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                You must have valid in-character probable cause (witnessed
                crime, 911 report, etc.) before detaining or arresting any
                individual.
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                ...
                Process suspects in a realistic and timely manner. Avoid
                dragging situations or stalling. Do not keep individuals
                restrained without moving RP forward.
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                Only confiscate items relevant to the crime. Do not take items
                out of revenge. Arrests should not escalate into shootings
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4">
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                EMS must focus solely on providing medical assistance. You are
                not law enforcement. Do not enter active crime or combat scenes
                until confirmed safe by Law Enforcement.
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                ...
                scene is cleared. Players may refuse treatment unless
                unconscious or incapacitated. Respect their choice unless doing
                so would break RP realism.
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 text-sm text-muted-foreground space-y-2">
                <p>
                  ...
                  issued to your department. Do not spawn or use weapons/items
                  not meant for your role.
                </p>
                <p>
                ...
                <p>
                  <strong>Emergency Lighting:</strong> Only activate
                  lights/sirens when responding to active emergencies or
                  transporting.
                </p>
                <p>
                  <strong>Vehicle Blocking:</strong> Roadblocks must serve a
                  valid RP purpose. Don't use them to trap or troll players.
                </p>
                <p>
                ...
                <p>
                  <strong>Aerial Units:</strong> Helicopters or drones may only
                  be used by authorized personnel under strict RP needs.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardContent className="p-6 text-sm text-muted-foreground space-y-2">
              <p>
                <strong>Entry Without Cause:</strong> You may not enter
                interiors without valid in-character reason. Curiosity alone is
                not enough.
              </p>
              <p>
              ...
              <p>
                <strong>Stacking Entry:</strong> Do not enter a property in
                large numbers unless justified by the scene.
              </p>
              <p>
                <strong>Re-entry Rules:</strong> If you die inside during a
                raid, you may not return unless revived or instructed by
                command/staff.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="grid gap-4">
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                ...
                officer on scene takes control. Do not use your panic button if
                you can communicate via radio. If your life or the life of
                another is in danger AND you cannot communicate via radio, you
                may use your panic button.
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                Handle fire suppression, rescue operations, and hazard
                mitigation. Do not interfere with law enforcement. Coordinate
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground">
                Focus on medical assistance and patient care. Maintain
                neutrality. Request scene clearance before entering active
                incidents.
              </CardContent>
            </Card>
        ...
        <Card className="border-blue-500/30 bg-blue-500/5">
          <CardContent className="p-6 text-center space-y-3">
            ...
            <p className="text-muted-foreground text-sm">
              ...
              emergency services. Adherence to these standards maintains
              community trust and creates an immersive experience for all
              players.
            </p>
          </CardContent>
        </Card>
