    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-lg text-muted-foreground">
          Important information about RESYNC Studios™ policies, guidelines, and legal documents
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {policyLinks.map((policy) => {
          ...
          return (
            <Card key={policy.href} className="flex flex-col hover:border-primary/50 transition-colors">
              <CardHeader>
                <div className="flex items-start justify-between gap-4">
                  <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
                    <Icon className="w-6 h-6 text-primary" />
                  </div>
                  <Button variant="ghost" size="icon" asChild className="h-8 w-8" data-testid={`link-${policy.href}`}>
      ...
      <Card className="bg-card border-primary/20">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            If you have any questions about our policies or guidelines, please don't hesitate to contact our support team.
          </p>
          <Button asChild>
