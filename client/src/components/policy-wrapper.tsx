...
export function PolicyWrapper({ slug, children }: PolicyWrapperProps) {
  ...
  if (policy) {
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl space-y-8">
        ...
        <div
          className="prose prose-invert max-w-none [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mt-8 [&_h2]:mb-4 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:mt-6 [&_h3]:mb-3 [&_p]:text-muted-foreground [&_p]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-2 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:space-y-2 [&_li]:text-muted-foreground [&_a]:text-primary [&_a]:underline [&_strong]:text-foreground"
